...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AirbnbLibraryAccessors extends SubDependencyFactory {
        private final AirbnbDeeplinkLibraryAccessors laccForAirbnbDeeplinkLibraryAccessors = new AirbnbDeeplinkLibraryAccessors(owner);

        public AirbnbLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>airbnb.deeplink</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AirbnbDeeplinkLibraryAccessors getDeeplink() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAirbnbDeeplinkLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AirbnbDeeplinkLibraryAccessors extends SubDependencyFactory {

        public AirbnbDeeplinkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>dispatch</b> with <b>com.airbnb:deeplinkdispatch</b> coordinates and
         * with version reference <b>airbnbDeeplink</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getDispatch() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("airbnb.deeplink.dispatch");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getProcessor() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("airbnb.deeplink.processor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>airbnbDeeplink</b> with value <b>6.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAirbnbDeeplink() { return getVersion("airbnbDeeplink"); }
        ...
        /**
         * Version alias <b>compose</b> with value <b>1.8.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.ksp</b> with value <b>1.9.23-1.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
