...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidDeeplinkLibraryAccessors laccForAndroidDeeplinkLibraryAccessors = new AndroidDeeplinkLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.deeplink</b>
         */
        public AndroidDeeplinkLibraryAccessors getDeeplink() {
            return laccForAndroidDeeplinkLibraryAccessors;
        }

    }

    public static class AndroidDeeplinkLibraryAccessors extends SubDependencyFactory {
        private final AndroidDeeplinkDisptacherLibraryAccessors laccForAndroidDeeplinkDisptacherLibraryAccessors = new AndroidDeeplinkDisptacherLibraryAccessors(owner);

        public AndroidDeeplinkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.deeplink.disptacher</b>
         */
        public AndroidDeeplinkDisptacherLibraryAccessors getDisptacher() {
            return laccForAndroidDeeplinkDisptacherLibraryAccessors;
        }

    }

    public static class AndroidDeeplinkDisptacherLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidDeeplinkDisptacherLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>disptacher</b> with <b>com.airbnb:deeplinkdispatch</b> coordinates and
         * with version reference <b>deeplink.dispatch</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("android.deeplink.disptacher");
        }

        /**
         * Dependency provider for <b>processor</b> with <b>com.airbnb:deeplinkdispatch-processor</b> coordinates and
         * with version reference <b>deeplink.dispatch</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getProcessor() {
            return create("android.deeplink.disptacher.processor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final DeeplinkVersionAccessors vaccForDeeplinkVersionAccessors = new DeeplinkVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>comGoogleDevtoolsKspGradlePlugin</b> with value <b>2.0.0-1.0.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.deeplink</b>
         */
        public DeeplinkVersionAccessors getDeeplink() {
            return vaccForDeeplinkVersionAccessors;
        }

    }

    public static class DeeplinkVersionAccessors extends VersionFactory  {

        public DeeplinkVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>deeplink.dispatch</b> with value <b>6.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDispatch() { return getVersion("deeplink.dispatch"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>ksp</b> with plugin id <b>com.google.devtools.ksp:com.google.devtools.ksp.gradle.plugin</b> and
